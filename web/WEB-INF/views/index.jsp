<%--
    Document   : index
    Created on : 27/08/2018, 21:14:49
    Author     : jonas
--%>
        ...
        <div class="container">
            ...
            <div>
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <a id="addcomment" href="adicionar" class="btn btn-lg btn-success" > <span class="glyphicon glyphicon-star" aria-hidden="true"></span> Adicionar Avaliação </a>
                        </div>
                        <div class="col-sm-3 col-sm-offset-6">
                            <div>
                                <h2> <small style="color: black">Avaliação </small>
                                    ${sessionScope.media}
                                    <small>/ 5</small></h2>
                                <button type="button" class="btn ${media >0  ? "btn-warning" : "btn-default" }" aria-label="Left Align">
                                    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                </button>
                                <button type="button" class="btn ${media >1  ? "btn-warning" : "btn-default" }" aria-label="Left Align">
                                    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                </button>
                                <button type="button" class="btn ${media >2  ? "btn-warning" : "btn-default" }" aria-label="Left Align">
                                    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                </button>
                                <button type="button" class="btn ${media >3  ? "btn-warning" : "btn-default" }" aria-label="Left Align">
                                    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                </button>
                                <button type="button" class="btn ${media >4  ? "btn-warning" : "btn-default" }" aria-label="Left Align">
                                    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
                                </button>
                            </div>
                        </div>
                            ...
                            <div>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="comment">${avaliacao.texto}</p>
                                        <div>
                                            <c:choose>
