<%--
    ...
    Created on : 27/08/2018, 21:15:58
    Author     : jonas
--%>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <br />
                            <form class="form-horizontal" action="/PhotoArt/adicionar" method="POST">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Título</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail3" name="titulo" placeholder="Muito bom!">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail4" class="col-sm-2 control-label">Usuário</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputEmail4" name="usuario" placeholder="@johndoe">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail5" class="col-sm-2 control-label">Avaliação</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="inputEmail5" name="texto" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
